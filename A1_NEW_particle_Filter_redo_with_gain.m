function A1_NEW_particle_Filter_redo_with_gain(sx, sy, sz, gx, gy, gz)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for t = 1:T
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    q_randX.coord = [0.1+q_new.coord(1) q_new.coord(2) q_new.coord(3)];
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    q_randY.coord = [q_new.coord(1) 0.1+q_new.coord(2) q_new.coord(3)];
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    q_randZ.coord = [q_new.coord(1) q_new.coord(2) 0.1+q_new.coord(3)];
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    step_gain = 0.12+0.01/(((q_near.cost-q_new.cost)+0.01));
    remove = [];
    z_update=[];
    add=[];
    r_new = q_near.coord;
    ...
    if (q_near.cost ~=0 && change_more)
        ...
        if ((change_q_next && change_more))    
           q_new = q_near; 
           mn = mean(x_P, 1);
           q_near.coord(1) = mn(1,1);
           q_near.coord(2) = mn(1,2);
           q_near.coord(3) = mn(1,3);
           line([q_near.coord(1), q_new.coord(1)], [q_near.coord(2), q_new.coord(2)], [q_near.coord(3), q_new.coord(3)], 'Color', 'k', 'LineWidth', 2); 
   ...
   hold on
    ...
    text5 = ['Time Taken: '];
    text6 = ['Algorithm: /bf{GA}']
    subtitle({text1,text4,text2,text3, text4, text5, text6});
end
